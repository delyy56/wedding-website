...
$(document).ready(function () {
      ...
      $(window).scroll(function () {
        20 <= $(window).scrollTop()
          ...
          ? ($("section.navigation").addClass("fixed"),
            $("header").css({ "border-bottom": "none", padding: "15px 0" }),
            $("header .member-actions").css({ top: "6px" }),
            $("header .navicon").css({ top: "13px" }))
          ...
          /* ÉTAT "EN HAUT DE PAGE" */
            ...
            $("header .member-actions").css({ top: "21px" }),
            $("header .navicon").css({ top: "28px" }));
      });
    }),
    $(function () {
  ...
  for (var n = 0; n < e.length; n++) {
    var o =
      ...
      '&amp;via=aliceswarooppatra&amp;hashtags=aliceandgregoire&amp;count=horizontal"style="width:105px; height:21px;"></iframe><iframe src="//www.facebook.com/plugins/like.php?href=' +
      encodeURIComponent(window.location) +
